USE [CodePulseDb]
GO
INSERT [dbo].[AspNetRoles] ([Id], [Name], [NormalizedName], [ConcurrencyStamp]) VALUES (N'44fc55c2-158d-45c1-8f37-359be5ef6f73', N'Writer', N'WRITER', N'44fc55c2-158d-45c1-8f37-359be5ef6f73')
GO
INSERT [dbo].[AspNetRoles] ([Id], [Name], [NormalizedName], [ConcurrencyStamp]) VALUES (N'f064f08d-3b96-44b2-94e0-45bdbc868ff6', N'Reader', N'READER', N'f064f08d-3b96-44b2-94e0-45bdbc868ff6')
GO
INSERT [dbo].[AspNetUsers] ([Id], [UserName], [NormalizedUserName], [Email], [NormalizedEmail], [EmailConfirmed], [PasswordHash], [SecurityStamp], [ConcurrencyStamp], [PhoneNumber], [PhoneNumberConfirmed], [TwoFactorEnabled], [LockoutEnd], [LockoutEnabled], [AccessFailedCount]) VALUES (N'a226da08-f00d-4f81-bbfe-3e119fe5c613', N'admin@codepulse.com', N'ADMIN@CODEPULSE.COM', N'admin@codepulse.com', N'ADMIN@CODEPULSE.COM', 0, N'AQAAAAIAAYagAAAAENem8Y5xY/Ot8wfrA88TVH8qCCiAsjv0PTauGtUuSvJKbxoCtp6L6UdoE/5LLdNrSQ==', N'096cea72-2d78-405e-99bd-ec0b282a446c', N'caa88429-7505-436a-9c95-6a4f3ff90587', NULL, 0, 0, NULL, 0, 0)
GO
INSERT [dbo].[AspNetUsers] ([Id], [UserName], [NormalizedUserName], [Email], [NormalizedEmail], [EmailConfirmed], [PasswordHash], [SecurityStamp], [ConcurrencyStamp], [PhoneNumber], [PhoneNumberConfirmed], [TwoFactorEnabled], [LockoutEnd], [LockoutEnabled], [AccessFailedCount]) VALUES (N'ba4d8eea-82b3-4efa-a7ff-8742caad866d', N'User1@codepulse.com', N'USER1@CODEPULSE.COM', N'User1@codepulse.com', N'USER1@CODEPULSE.COM', 0, N'AQAAAAIAAYagAAAAEHwpzR7OTpw3DT25b9hJ2EeUoaqzvfMA/BFX1HE+8dNb57aHJqIr8qx7Fvb6oW+6ng==', N'WMWA7LVXI7DPKDOV5AKR6AI26GKW4JAG', N'9fe3f1c5-5f02-4d45-bfce-533ff77bd3c6', NULL, 0, 0, NULL, 1, 0)
GO
INSERT [dbo].[AspNetUserRoles] ([UserId], [RoleId]) VALUES (N'a226da08-f00d-4f81-bbfe-3e119fe5c613', N'44fc55c2-158d-45c1-8f37-359be5ef6f73')
GO
INSERT [dbo].[AspNetUserRoles] ([UserId], [RoleId]) VALUES (N'a226da08-f00d-4f81-bbfe-3e119fe5c613', N'f064f08d-3b96-44b2-94e0-45bdbc868ff6')
GO
INSERT [dbo].[AspNetUserRoles] ([UserId], [RoleId]) VALUES (N'ba4d8eea-82b3-4efa-a7ff-8742caad866d', N'f064f08d-3b96-44b2-94e0-45bdbc868ff6')
GO
INSERT [dbo].[BlogSpot] ([Id], [Title], [Description], [Content], [FeaturedImageUrl], [UrlHandle], [PublishedDate], [Author], [IsVisible]) VALUES (N'f02bb5b2-1bb3-44f6-7267-08db615ccdfb', N'Creating an Interactive HTML Website with ChatGPT: Enhancing User Engagement', N'While HTML (Hypertext Markup Language) is the backbone of any website, adding conversational elements can take user engagement to a whole new level. In this blog post, we will explore in detail how to create an HTML website with ChatGPT, a powerful language model developed by OpenAI. By integrating ChatGPT into your website, you can provide users with a personalized and interactive experience. So, let''s dive in and learn how to harness the capabilities of ChatGPT to enhance your HTML website!', N'**Introduction:**
...
', N'https://localhost:7144/Images/Red Book.jpg', N'html-website-using-chatgpt', CAST(N'2023-05-30T22:35:50.6230000' AS DateTime2), N'Sameer Saini', 1)
GO
...
', N'https://images.pexels.com/photos/5483077/pexels-photo-5483077.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', N'http-requests-javascript', CAST(N'2023-06-14T07:40:10.9560000' AS DateTime2), N'Sameer Saini', 1)
GO
INSERT [dbo].[BlogSpot] ([Id], [Title], [Description], [Content], [FeaturedImageUrl], [UrlHandle], [PublishedDate], [Author], [IsVisible]) VALUES (N'908ba10a-f3cd-4918-8c8b-08db6cab4598', N'Building a Simple Web API Using C# and .NET Core: A Step-by-Step Guide', N'Building a robust and efficient web API is a fundamental skill for modern application development. In this comprehensive guide, we will walk you through the process of creating a simple web API using C# and .NET Core.', N'## Introduction
...
', N'https://images.pexels.com/photos/7367/startup-photo.jpg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', N'web-api-csharp', CAST(N'2023-06-14T07:45:30.0410000' AS DateTime2), N'Sameer Saini', 1)
GO
INSERT [dbo].[BlogSpot] ([Id], [Title], [Description], [Content], [FeaturedImageUrl], [UrlHandle], [PublishedDate], [Author], [IsVisible]) VALUES (N'9449dc77-3fc4-4b72-8c8c-08db6cab4598', N'Reading an Excel File in C#: A Step-by-Step Guide', N'Reading data from Excel files is a common requirement in many applications. In this comprehensive guide, we will walk you through the process of reading an Excel file in C# using the .NET framework', N'
...
', N'https://images.pexels.com/photos/590022/pexels-photo-590022.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', N'read-excel-csharp', CAST(N'2023-06-14T07:48:27.0310000' AS DateTime2), N'Sameer Saini', 1)
GO
INSERT [dbo].[BlogSpot] ([Id], [Title], [Description], [Content], [FeaturedImageUrl], [UrlHandle], [PublishedDate], [Author], [IsVisible]) VALUES (N'061265f3-cdfb-428f-8c8d-08db6cab4598', N'Building a Simple Navigation Bar: A Step-by-Step Guide', N'A navigation bar is an essential component of any website or web application, providing users with easy access to different sections and pages.', N'## Introduction
...
', N'https://images.pexels.com/photos/109371/pexels-photo-109371.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', N'simple-navigation-bar', CAST(N'2023-06-14T07:51:14.4760000' AS DateTime2), N'Sameer Saini', 1)
GO
INSERT [dbo].[Category] ([Id], [Name], [UrlHandle]) VALUES (N'9e527d68-8c04-4a14-c6cd-08dc7b38bcc6', N'HTML', N'HTML Blogs -Updated')
GO
INSERT [dbo].[Category] ([Id], [Name], [UrlHandle]) VALUES (N'2bfd16af-3729-4bc3-2f84-08dc7bc25f47', N'CSS', N'CSS Blog')
GO
INSERT [dbo].[Category] ([Id], [Name], [UrlHandle]) VALUES (N'4acd7126-bbe5-474c-f34a-08dc7e110c23', N'JS', N'JS Blog')
GO
INSERT [dbo].[Category] ([Id], [Name], [UrlHandle]) VALUES (N'ab672918-b716-4a5d-f34b-08dc7e110c23', N'SQL', N'SQL Blog')
GO
INSERT [dbo].[Category] ([Id], [Name], [UrlHandle]) VALUES (N'0f12ffac-aae0-4ce7-f34c-08dc7e110c23', N'Angular', N'Angular Blog')
GO
INSERT [dbo].[Category] ([Id], [Name], [UrlHandle]) VALUES (N'7db41271-2251-4280-19db-08dc927d6dab', N'C#', N'C# Blog')
GO
INSERT [dbo].[Category] ([Id], [Name], [UrlHandle]) VALUES (N'24191275-b03c-4350-19dc-08dc927d6dab', N'TS', N'Type Script Blog')
GO
INSERT [dbo].[Category] ([Id], [Name], [UrlHandle]) VALUES (N'd4b86f5e-69ec-4975-19dd-08dc927d6dab', N'React', N'React Blog')
GO
INSERT [dbo].[Category] ([Id], [Name], [UrlHandle]) VALUES (N'd3067182-3751-4b5a-19de-08dc927d6dab', N'ASP.NET Core', N'Dot Net Core Blog')
GO
INSERT [dbo].[Category] ([Id], [Name], [UrlHandle]) VALUES (N'd3294336-fea3-447a-19df-08dc927d6dab', N'ASP.NET', N'ASP.NET Blog')
GO
INSERT [dbo].[Category] ([Id], [Name], [UrlHandle]) VALUES (N'96eb2a68-79cd-4f8a-19e0-08dc927d6dab', N'EF', N'Entity Framework Blog')
GO
INSERT [dbo].[BlogSpotCategory] ([blogSpotsId], [categoriesId]) VALUES (N'f02bb5b2-1bb3-44f6-7267-08db615ccdfb', N'9e527d68-8c04-4a14-c6cd-08dc7b38bcc6')
GO
INSERT [dbo].[BlogSpotCategory] ([blogSpotsId], [categoriesId]) VALUES (N'81495368-62a1-434c-7268-08db615ccdfb', N'9e527d68-8c04-4a14-c6cd-08dc7b38bcc6')
GO
INSERT [dbo].[BlogSpotCategory] ([blogSpotsId], [categoriesId]) VALUES (N'f02bb5b2-1bb3-44f6-7267-08db615ccdfb', N'2bfd16af-3729-4bc3-2f84-08dc7bc25f47')
GO
INSERT [dbo].[BlogSpotCategory] ([blogSpotsId], [categoriesId]) VALUES (N'81495368-62a1-434c-7268-08db615ccdfb', N'2bfd16af-3729-4bc3-2f84-08dc7bc25f47')
GO
INSERT [dbo].[BlogSpotCategory] ([blogSpotsId], [categoriesId]) VALUES (N'7ced7773-a5e1-4eaa-8c8a-08db6cab4598', N'4acd7126-bbe5-474c-f34a-08dc7e110c23')
GO
INSERT [dbo].[BlogSpotCategory] ([blogSpotsId], [categoriesId]) VALUES (N'f02bb5b2-1bb3-44f6-7267-08db615ccdfb', N'ab672918-b716-4a5d-f34b-08dc7e110c23')
GO
INSERT [dbo].[__EFMigrationsHistory] ([MigrationId], [ProductVersion]) VALUES (N'20240511185256_Initial', N'8.0.4')
GO
INSERT [dbo].[__EFMigrationsHistory] ([MigrationId], [ProductVersion]) VALUES (N'20240530074636_Foo', N'8.0.4')
GO
INSERT [dbo].[__EFMigrationsHistory] ([MigrationId], [ProductVersion]) VALUES (N'20240605030716_Adding BlogImage', N'8.0.4')
GO
INSERT [dbo].[__EFMigrationsHistory] ([MigrationId], [ProductVersion]) VALUES (N'20240611031304_Intiate Auth', N'8.0.6')
GO
INSERT [dbo].[BlogImages] ([Id], [FileName], [FileExtension], [Title], [Url], [DateCreated]) VALUES (N'fe328f6a-1d67-4c6d-761d-08dc85d64f61', N'test', N'.jpg', N'test title', N'https://localhost:7144/Images/test.jpg', CAST(N'2024-06-06T08:40:52.1358733' AS DateTime2))
GO
INSERT [dbo].[BlogImages] ([Id], [FileName], [FileExtension], [Title], [Url], [DateCreated]) VALUES (N'5ef0e4a8-daf3-40bd-3291-08dc85e85ed8', N'Red Book', N'.jpg', N'Sample testing 2', N'https://localhost:7144/Images/Red Book.jpg', CAST(N'2024-06-06T10:50:24.9381408' AS DateTime2))
GO
